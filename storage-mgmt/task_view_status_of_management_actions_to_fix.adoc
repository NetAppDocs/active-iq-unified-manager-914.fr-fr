...
.Étapes
. Cliquez sur *Management actions* dans le volet de navigation de gauche. Vous pouvez également cliquer image:../media/more_icon.gif["plus d'icône"]en haut du panneau *actions de gestion* sur le *Tableau de bord* et sélectionner la vue que vous souhaitez voir.
+
