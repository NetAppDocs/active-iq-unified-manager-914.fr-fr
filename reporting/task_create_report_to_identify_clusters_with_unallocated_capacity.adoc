...
. Enregistrez la vue avec un nom spécifique qui reflète ce que la vue affiche, par exemple « `capacité LUN non allouée la plus' » et cliquez sur la coche (image:../media/blue_check.gif[""]).
