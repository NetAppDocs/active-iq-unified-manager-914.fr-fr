...
Pour plus d'informations sur le réglage des paramètres QoS, reportez-vous àla section https://docs.netapp.com/us-en/ontap/performance-admin/index.html["Présentation de la gestion des performances"].
