...
Cacher un objet sélectionné
 a| 
Cliquez sur l'icône en forme d'œil de l'objet sélectionné (image:../media/eye_icon.gif[""]) dans le volet de comparaison. Les données de l'objet sont masquées et l'icône de l'œil correspondant à cet objet devient grise.
