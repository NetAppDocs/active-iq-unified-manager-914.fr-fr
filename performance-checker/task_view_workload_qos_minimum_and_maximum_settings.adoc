...
Pour plus d'informations sur le réglage des paramètres QoS, reportez-vous à la section http://docs.netapp.com/ontap-9/topic/com.netapp.doc.pow-perf-mon/home.html["Présentation de la gestion des performances"]
