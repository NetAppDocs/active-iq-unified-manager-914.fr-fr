...
. Cliquez sur *Nom* et entrez `*HealthTest*` dans le champ *Nom de l'alerte*.
. Cliquez sur *Ressources* et, dans l'onglet inclure, sélectionnez *volumes* dans la liste déroulante.
+
.. Entrez `*abc*` dans le champ *Nom contient* pour afficher les volumes dont le nom contient « abc ».
...
.. Cliquez sur *exclure*, entrez `*xyz*` dans le champ *Nom contient*, puis cliquez sur *Ajouter*.
...
. Cliquez sur *actions* et saisissez `*sample@domain.com*` dans le champ alerte ces utilisateurs.
