...
* Depuis n'importe quelle page d'inventaire de workload (volume, LUN, workload, partage NFS ou partage SMB/CIFS), en cliquant sur l'icône plus image:../media/more_icon.gif[""], puis sur *Analyze Workload*
