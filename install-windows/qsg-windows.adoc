...
Pour obtenir des informations détaillées sur la configuration système requise, reportez-vous aux sections link:../install-windows/concept_requirements_for_installing_unified_manager.html["Conditions requises pour l'installation de Unified Manager"]et link:http://mysupport.netapp.com/matrix["Matrice d'interopérabilité"^].
